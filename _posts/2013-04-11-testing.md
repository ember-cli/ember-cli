...
[ember-qunit](https://github.com/rpflorence/ember-qunit) includes a
way to minimize what you have to load into the runtime during testing.
It provides convenience methods that will only load what is truly
necessary for your test.
