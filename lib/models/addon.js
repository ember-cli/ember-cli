...
Addon.prototype.shouldCompileTemplates = function() {
  ...
  if (fs.existsSync(addonTreePath)) {
    files = files.concat(this.walkSync(addonTreePath));
  }

  if (fs.existsSync(addonTemplatesTreePath)) {
    files = files.concat(this.walkSync(addonTemplatesTreePath));
  }
...
*/
Addon.prototype.compileTemplates = function() {
  this._requireBuildPackages();
  ...
  if (this.shouldCompileTemplates()) {
    ...
    var podTemplates = new this.Funnel(this._treeFor('addon'), {
...
Addon.prototype.compileAddon = function(tree) {
  ...
  var templatesTree = this.compileTemplates();
