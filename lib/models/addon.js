...
let addonProto = {
  ...
  */
  ...
  jshintAddonTree() {
    warn('Please use function #lintAddonTree instead of jshintAddonTree');
    this.lintAddonTree();
  },
  /**
    Invokes lintTree for addon that implements lintTree function

    @private
    @method lintAddonTree
    @return {Tree} Tree with tests generated by included linters
  */
  lintAddonTree() {
    this._requireBuildPackages();
    ...
    return new Funnel(lintedAddon, {
      ...
      annotation: `Funnel: Addon#lintAddonTree(${this.name})`,
    });
  },
