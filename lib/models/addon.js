...
Addon.prototype.treeForAddon = function(tree) {
  ...
  var appStylesTree = this.compileStyles(this.treeFor('styles'));
  var addonStylesTree = this.compileStyles(this._treeFor('addon-styles'));
  var jsTree;
  ...
  return this.mergeTrees([jsTree, addonStylesTree, appStylesTree].filter(Boolean));
};
