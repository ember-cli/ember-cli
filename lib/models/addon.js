...
let addonProto = {
  ...
  */
  jshintAddonTree() {
    ...
    let testSupport = this._treePathFor('test-support');
    let lintTestSupportTrees = this._eachProjectAddonInvoke('lintTree', ['test-support', testSupport]);

    let addonTestSupport = this.addonTestSupportFiles(this._treePathFor('addon-test-support'));
    let lintAddonTestSupportTrees = this._eachProjectAddonInvoke('lintTree', ['addon-test-support', addonTestSupport]);

    let lintTrees = [].concat(
      lintJsTrees,
      lintTemplateTrees,
      lintTestSupportTrees,
      lintAddonTestSupportTrees
    ).filter(Boolean);
