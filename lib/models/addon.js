...
let addonProto = {
  ...
  */
  ...
  /**
    ...
    @param {Tree} tree
    @returns {Tree} Template file tree
  */
  ...
  /**
    ...
    @param {Tree} tree
    @returns {Tree} Addon Template file tree
  */
  ...
  */
  ...
  /**
    ...
    @param {Tree} tree
    @returns {Tree} Test Support file tree
  */
  ...
  */
  ...
  /**
     ...
     @returns {Boolean} indicates if pod based templates need to be compiled for this addon
  */
  ...
  /**
    ...
    @returns {Tree} Compiled templates tree
  */
  ...
  /**
    ...
    @returns {Tree} Compiled addon tree
  */
  compileAddon(tree) {
    if (!this.options) {
      throw new SilentError(
  ...
  /**
    ...
    @private
    @function jshintAddonTree
    @returns {Tree} Tree with JShint output (tests)
  */
  jshintAddonTree() {
    let trees = [];
  ...
  /**
    ...
    @returns {Tree} Preprocessed javascript
  */
  preprocessJs() {
  ...
  /**
    ...
    @returns {Tree} Processed javascript file tree
  */
  ...
  */
  ...
  /**
    ...
    @returns {String} The path for blueprints
  ...
  */
  ...
  /**
    ...
    @returns {Object} Configuration object to be merged with application configuration.
  ...
  */
  ...
  /**
    ...
    @returns {Object} The addon's dependencies based on the addon's package.json
  */
  dependencies() {
    let pkg = this.pkg;
  ...
  /**
    @public
    @function isEnabled
    @returns {Boolean} Whether or not this addon is enabled
  */
  isEnabled() {
    return true;
  },
  ...
  /**
    ...
    @returns {Boolean} Whether or not a child addon is supposed to be included
...
/**
  ...
  @returns {Object} An object with included commands
...
/**
  ...
  @returns {Object} An object with custom transforms
 ...
 **Uses:**
 ...
 @public
 @function setupPreprocessorRegistry
