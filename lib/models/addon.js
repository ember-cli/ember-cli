...
let heimdallLogger = require('heimdalljs-logger');
...
let AddonDiscovery = require('../models/addon-discovery');
let AddonsFactory = require('../models/addons-factory');
...
let findAddonByName = require('../utilities/find-addon-by-name');
let experiments = require('../experiments');
let heimdall = require('heimdalljs');
let calculateCacheKeyForTree = require('calculate-cache-key-for-tree');
