      ...
      if (this.root === this.parent.root) {
        if (parentName !== this.name && !process.env.EMBER_CLI_IGNORE_ADDON_NAME_MISMATCH) {
          ...
          throw new SilentError(
            ...
            'For more information about this workaround, which will be removed in ember-cli v3.9, see: https://github.com/ember-cli/ember-cli/pull/7950. '+
            'This error can be disabled by setting env variable EMBER_CLI_IGNORE_ADDON_NAME_MISMATCH to "true"');
        }
