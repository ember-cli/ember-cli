...
/*
  ...
  @param {String} path
*/
Blueprint.registerAddon = function(path) {
  Blueprint.addons.push(path);
}
...
/*
  ...
  @property addonPaths
*/
Blueprint.addonPaths = [];

/*
  @static
  @method registerAddonPath
  @namespace Blueprint
  @param {String} path
*/
Blueprint.registerAddonPath = function(path) {
  if (path != undefined) {
    Blueprint.addonPaths.push(path);
  }
}
...
function generateLookupPaths(lookupPaths) {
  ...
  lookupPaths = lookupPaths.concat(Blueprint.addonPaths);
