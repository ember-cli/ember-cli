...
@module ember-cli
*/
let FileInfo = require('./file-info');
let Promise = require('../ext/promise');
let chalk = require('chalk');
let MarkdownColor = require('../utilities/markdown-color');
let printableProperties = require('../utilities/printable-properties').blueprint;
let sequence = require('../utilities/sequence');
let printCommand = require('../utilities/print-command');
let insertIntoFile = require('../utilities/insert-into-file');
let cleanRemove = require('../utilities/clean-remove');
let fs = require('fs-extra');
let existsSync = require('exists-sync');
let inflector = require('inflection');
let minimatch = require('minimatch');
let path = require('path');
let stringUtils = require('ember-cli-string-utils');
let _ = require('ember-cli-lodash-subset');
let walkSync = require('walk-sync');
let SilentError = require('silent-error');
let CoreObject = require('core-object');
let EOL = require('os').EOL;
let bowEpParser = require('bower-endpoint-parser');
...
let writeFile = Promise.denodeify(fs.outputFile);
...
let Blueprint = CoreObject.extend({
  ...
  */
  taskFor(dasherizedName) {
    let Task = require(`../tasks/${dasherizedName}`);
