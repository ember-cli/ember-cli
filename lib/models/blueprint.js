...
*/
var Blueprint = CoreObject.extend({
  init: function(blueprintPath) {
  ...
  */
  ...
  /**
    ...
    @return {Promise}
  */
  addBowerPackageToProject: function(packageName, target, installOptions) {
    var packageObject = {name: packageName};
  ...
  /**
    ...
    @return {Promise}
  */
  addBowerPackagesToProject: function(packages, installOptions) {
  ...
  /**
    ...
    @return {Promise}
  */
  addAddonToProject: function(options) {
    var taskOptions = {};
  ...
  */
  ...
  /**
    ...
    @return {String} formatting help string
  */
...
/**
 @private
 @method finishProcessingForInstall
 @return {Promise} sequence of promises to fulfil
*/
...
/**
 @private
 @method finishProcessingForUninstall
 @return {Array}
*/
