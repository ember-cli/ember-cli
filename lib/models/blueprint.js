...
/*
  ...
  module.exports = {
    ...
    validateOptions: function(options) {
      // Validate blueprint options here.
      throw new SilentError('Describe the validation error');
    },
  ...
  Use the `validateOptions` hook to add custom validation of the
  blueprint options. The default hook requires an entity name because
  most generators will need one.

  This hook receives the options object as its first argument. If a
  validation error is detected, it should throw a `SilentError` object.
  ...
  make any changes to the entity name, but makes sure it doesn't have a
  trailing slash if an entity name is present.
...
/*
  Hook for validating generator options
  @method validateOptions
  @param {Object} options
  @return {null}
*/
Blueprint.prototype.validateOptions = function(options) {
  if (options.entity && !options.entity.name) {
