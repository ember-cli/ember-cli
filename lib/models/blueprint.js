...
let Blueprint = CoreObject.extend({
  ...
  */
  ...
  /**
    ...
    @function filesPath
    @param {Object} options
    @returns {String} Path to the blueprints files directory.
  */
  filesPath(/* options */) {
    return path.join(this.path, 'files');
  },
  ...
  /**
    ...
    @function files
    @param {Object} options
    @returns {Array} Contents of the blueprint's files directory
  */
  files(/* options */) {
    if (this._files) {
      return this._files;
  ...
  */
  ...
  /**
    @function processFilesForUninstall
    @param {String} intoDir
    @param {Object} templateVariables
  */
  ...
  */
  ...
  /**
    ...
    @function removePackagesFromProject
    @param {Array} packages
    @returns {Promise}
  */
...
/**
  @private
  @function markIdenticalToBeSkipped
  @param {FileInfo} info
*/
...
/**
  @private
  @function gatherConfirmationMessages
