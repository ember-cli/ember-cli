...
class Project {
  ...
  */
  ...
  /**
    ...
    @returns {Boolean} Whether this is an Ember CLI project
   */
  isEmberCLIProject() {
  ...
  /**
    ...
    @function isEmberCLIAddon
    @returns {Boolean} Whether or not this is an Ember CLI Addon.
   */
  isEmberCLIAddon() {
  ...
  */
  ...
  /**
    ...
    @returns {Object}           Merged configuration of all addons
   */
  ...
  /**
    ...
    @returns {Boolean}      Whether or not the file is present
   */
  has(file) {
  ...
  /**
    ...
    @private
    @function supportedInternalAddonPaths
  */
  ...
  /**
    ...
    @returns {Object} Addon names and command maps as key-value pairs
   */
  addonCommands() {
  ...
  /**
    ...
    @private
    @function localBlueprintLookupPath
    @returns {String} Path to blueprints
   */
  ...
  /**
    ...
    @private
    @function addonBlueprintLookupPaths
    @returns {Array} List of paths
   */
  ...
  /**
    ...
    @returns {String} The test file content
   */
  generateTestFile() {
