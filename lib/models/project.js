...
Project.prototype.isEmberCLIProject = function() {
  var isProject = (this.cli ? this.cli.npmPackage : 'ember-cli') in this.dependencies();
  debug('isProject: ' + isProject);
  return isProject;
};
...
Project.prototype.isEmberCLIAddon = function() {
  var isAddon = !!this.pkg.keywords && this.pkg.keywords.indexOf('ember-addon') > -1;
  debug('isAddon: ' + isAddon);
  return isAddon;
};
