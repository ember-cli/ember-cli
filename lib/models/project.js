...
class Project {
  ...
  */
  ...
  blueprintLookupPaths() {
    ...
    let octaneBlueprintPath = path.join(__dirname, '..', '..', 'node_modules', 'ember-octane-blueprint', 'blueprints');
    let lookupPaths = [octaneBlueprintPath];
    if (this.isEmberCLIProject()) {
      lookupPaths.push(this.localBlueprintLookupPath());
    }
