...
Project.prototype.discoverAddons = function() {
  var addonsList = this.addonDiscovery.discover(this);
  var addonPackages = {};
  function addToHash(list) {
    list.forEach(function(addonPkg) {
      addonPackages[addonPkg.name] = addonPkg;
      addToHash(addonPkg.childAddons);
    });
  }
  addToHash(addonsList);
