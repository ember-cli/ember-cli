...
Project.prototype.setupNodeModulesPath = function() {
  ...
  this.emberCliNodeModulesPath = this.nodeModulesPath &&
    nodeModulesPath(path.join(this.nodeModulesPath, 'ember-cli'));
...
Project.prototype.supportedInternalAddonPaths = function() {
  ...
  return [
    ...
    path.join(this.emberCliNodeModulesPath, 'ember-cli-legacy-blueprints')
  ];
};
