...
Project.prototype.blueprintsPaths = function() {
  var lookupPaths = [this.blueprintsPath()];
  var addonLookupPaths = this.addonBlueprintsPaths();

  return lookupPaths.concat(addonLookupPaths);
};

Project.prototype.addonBlueprintsPaths = function() {
