...
class Project {
  ...
  */
  ...
  /**
    Returns the targets of this project from `config/targets.js` if present,
    otherwise from the project's browserslist config (`package.json#browserslist`,
    `.browserslistrc`, or `BROWSERSLIST`), otherwise the default targets.
  ...
  */
  get targets() {
    ...
    if (fs.existsSync(`${targetsPath}.js`)) {
      ...
      this._targets = {
        browsers: browserslist.loadConfig({ path: this.root }) ?? [
