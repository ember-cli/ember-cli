...
const hwinfo = {
   ...
   * @for HardwareInfo
   * @param {String} platform The current hardware platform.
   *                                           USED FOR TESTING ONLY.
   * @returns {null|Boolean} `true` iff the host is running on battery power or
   ...
   *
   * @private
   * @function memorySwapUsed
   * @param {String} platform The current hardware platform.
   *                                           USED FOR TESTING ONLY.
   * @returns {null|Number} The amount of used swap space, in bytes.  `null` if
   ...
   * @private
   * @function memoryUsed
   * @returns {Object} The Resident Set Size, as reported by
   *                  `process.memoryUsage`.
   */
  memoryUsed() {
   ...
   * @param {String} platform The current hardware platform.
   *                                           USED FOR TESTING ONLY.
   * @returns {Array<Number>} The one-, five-, and fifteen-minute processor load
   *                         averages.
   */
   ...
   * @returns {Number} The average processor speed in MHz.
   */
  processorSpeed() {
    const cpus = os.cpus();
   ...
   * @private
   * @function uptime
   * @returns {Number} The number of seconds since the host was started.
   */
  uptime() {
    return os.uptime();
  },
