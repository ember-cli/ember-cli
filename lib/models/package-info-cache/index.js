...
class PackageInfoCache {
   ...
   * @public
   * @function hasErrors
   * @returns true if there are any errors in the cache, for any entries, else false.
   */
  hasErrors() {
   ...
   * @returns {PackageInfo} the PackageInfo object for the given Project object.
   ...
   * about into the cache.
   * @returns {PackageInfo} the PackageInfo object for the given Addon object.
   ...
   * @returns {PackageInfo} or {NodeModulesList} the desired entry.
   */
  getEntry(path) {
