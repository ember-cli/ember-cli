...
class PackageInfo {
   ...
   * @returns {Object} a JavaScript object keyed on dependency name/path with
   ...
   * @returns {Boolean} true if this packageInfo is for a Project, false otherwise.
   */
  isForProject() {
   ...
   *
   * @function isForAddon
   * @returns {Boolean} true if this packageInfo is for an Addon, false otherwise.
   */
  isForAddon() {
   ...
   *
   * @function isForEngine
   * @returns {Boolean} true if this pkgInfo is configured as an engine & false otherwise
   */
  isForEngine() {
   ...
   *
   * @function isForLazyEngine
   * @returns {Boolean} true if this pkgInfo is configured as an engine and the
   ...
   *
   * @function isForBundleHost
   * @returns {Boolean} true if this pkgInfo is for a bundle host, false otherwise.
   */
  isForBundleHost() {
   ...
   *
   * @function discoverProjectAddons
   */
   ...
   *
   * @function generateAddonPackages
   ...
   *
   * @private
   * @function getAddonConstructor
   * @returns {AddonConstructor} an instance of a constructor function for the Addon class
   ...
   *
   * @private
   * @function constructAddonInstance
   ...
   * @returns {Object} the constructed instance of the addon
   */
   ...
   *
   * @function _getAddonEntryPoint
   * @returns {Object|Function} The exported addon entry point
   * @private
   */
  _getAddonEntryPoint() {
