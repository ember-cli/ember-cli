 ...
 *
 * @function resolvePerBundleAddonCacheUtil
 * @param {Project} project
 * @returns {{allowCachingPerBundle: Function}}
 */
...
class PerBundleAddonCache {
   ...
   *
   * @function allowCachingPerBundle
   * @param {Object|Function} addonEntryPointModule
   * @returns {Boolean} true if the given constructor function or class supports caching per bundle, false otherwise
   */
   ...
   *
   * @function createBundleHostCacheEntry
   * @param {PackageInfo} bundleHostPkgInfo bundle host's pkgInfo.realPath
   * @returns {Object} an object in the form of a bundle-host cache entry
   */
   ...
   * @returns {Object} the object in the 'parent' chain that is a bundle host.
   ...
   * new addon.
   *
   * @function bundleHostOwnsInstance
   ...
   * @returns {Boolean} true if the bundle host is to "own" the instance, false otherwise.
   */
   ...
   * @returns {Addon|Proxy} An addon instance (for the first copy of the addon) or a Proxy.
