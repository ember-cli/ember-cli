...
module.exports = Task.extend({
  setupBroccoliBuilder: function() {
    ...
    if (tree && !buildFile) {
      deprecate('Brofile.js has been deprecated in favor of ember-cli-build.js. Please see the transition guide: https://github.com/ember-cli/ember-cli/blob/master/TRANSITION.md#user-content-brocfile-transition');
      this.tree = tree;
      
    } else if (tree && buildFile) {
      deprecate('Found both Brocfile.js and ember-cli-build.js, please remove the Brocfile.js.  Building with ember-cli-build.js. Please see the transition guide: https://github.com/ember-cli/ember-cli/blob/master/TRANSITION.md#user-content-brocfile-transition');
      this.tree = buildFile(this.project);
    } else {
      this.tree = buildFile(this.project);
    }
