...
class HostInfoCache {
   ...
   *
   * @function _findNearestBundleHost
   ...
   *
   * @function _getBundledPackageInfos
   * @param {PackageInfo} pkgInfoToStartAt
   * @returns {Set<PackageInfo>}
   * @private
   */
   ...
   * @returns {{ hostPackageInfo: PackageInfo, hostAndAncestorBundledPackageInfos: Set<PackageInfo> }}
   */
