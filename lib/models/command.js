...
let isGitRepo = require('is-git-url');
let camelize = require('ember-cli-string-utils').camelize;
let getCallerFile = require('get-caller-file');
let printableProperties = require('../utilities/printable-properties').command;
...
let WatchDetector = require('../models/watch-detector');
