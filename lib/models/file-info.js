...
let lstat = Promise.denodeify(fs.stat);
let chalk = require('chalk');
let EditFileDiff = require('./edit-file-diff');
let EOL = require('os').EOL;
let isBinaryFile = require('isbinaryfile').sync;
let canEdit = require('../utilities/open-editor').canEdit;
let processTemplate = require('../utilities/process-template');
