    ...
    return [
      {
        ...
        when: !newCommandOptions.blueprint,
        choices: [
          {
            name: 'App',
            value: 'app',
      ...
      },
      {
        name: 'name',
        type: 'input',
        message: ({ blueprint }) => `Please provide the name of your ${blueprint ?? 'app'}:`,
      ...
      },
      {
        name: 'langSelection',
        type: 'list',
        message: ({ blueprint }) => `Please provide the spoken/content language of your ${blueprint ?? 'app'}:`,
