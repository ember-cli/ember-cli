...
module.exports = class LiveReloadServer {
  ...
  getMiddleware(options) {
    ...
    if (options.liveReload) {
      if (options.liveReloadPort && this.port !== options.liveReloadPort) {
        this.liveReloadServer = this.createServerforSpecifiedPort(options, Server);
      } else if (options.ssl) {
  ...
  createServerforSpecifiedPort(options, Server) {
    let liveReloadServer = new Server({
      dashboard: 'false',
      prefix: this.liveReloadPrefix,
      port: options.liveReloadPort,
    });
    liveReloadServer.listen(options.liveReloadPort, options.liveReloadHost);
