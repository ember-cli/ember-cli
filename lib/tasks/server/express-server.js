...
class ExpressServerTask extends Task {
  constructor(options) {
    ...
    // This should be migrated to require('http2') when we have migrated to express@5 which supports the built-in http2 bindings
    // eslint-disable-next-line node/no-unpublished-require
    this.https = this.https || require('spdy');
