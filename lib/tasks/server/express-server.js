...
exports.start = function(options) {
  ...
  if (options['liveReload'] === true) {
    middleware = chain(middleware, livereloadMiddleware({ port: options.liveReloadPort }));
  }

  middleware = chain(middleware, serveFilesMiddleware({ watcher: options.watcher, baseURL: baseURL }));
