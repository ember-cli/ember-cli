...
const DEFAULT_APP = '@ember/octane-app-blueprint';
const DEFAULT_ADDON = '@ember/octane-addon-blueprint';
...
InstallBlueprintTask.DEFAULT_APP = DEFAULT_APP;
InstallBlueprintTask.DEFAULT_ADDON = DEFAULT_ADDON;
