...
let lookupCommand = require('../cli/lookup-command');
let stringUtils = require('ember-cli-string-utils');
let assign = require('ember-cli-lodash-subset').assign;
let GenerateCommand = require('./generate');
let RootCommand = require('../utilities/root-command');
let JsonGenerator = require('../utilities/json-generator');
