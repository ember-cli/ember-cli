...
module.exports = Command.extend({
  ...
  availableOptions: [
    ...
    { name: 'timeout',              type: Number,  default: 120000,        aliases: ['to'],                                                    description: 'Timeout (in ms) for incoming requests' },
    { name: 'proxy-timeout',        type: Number,  default: 0,             aliases: ['pto'],                                                   description: 'Timeout (in ms) for outgoing proxy requests' },
