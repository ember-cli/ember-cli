...
module.exports.run = function run(options) {
  ...
  options.port           = options.cliOptions.port || DEFAULT_PORT;
  options.host           = options.cliOptions.host || DEFAULT_HOST;
  options.liveReloadPort = options.liveReloadPort || (parseInt(options.port, 10) - 8000) + LIVE_RELOAD_PORT;
  options.proxyPort = options.cliOptions['proxy-port'];
  options.proxyHost = options.cliOptions['proxy-host'] || DEFAULT_HOST;
