...
module.exports = Command.extend({
  ...
  async run(commandOptions, rawArgs) {
    ...
    blueprintOpts.pnpm = await isPnpmProject(project.root);
    ...
    const packageManager = commandOptions.pnpm ? 'pnpm' : commandOptions.yarn ? 'yarn' : 'npm';
