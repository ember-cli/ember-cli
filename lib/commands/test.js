...
module.exports = Command.extend({
  ...
  availableOptions: [
    { name: 'environment', type: String,  default: 'test',          aliases: ['e'], description: 'Test environment' },
    { name: 'config-file', type: String,  default: './testem.json', aliases: ['c', 'cf'], description: 'Test configuration file' },
    { name: 'server',      type: Boolean, default: false,           aliases: ['s'], description: 'Run test server' },
    { name: 'host',        type: String,                            aliases: ['H'], description: 'Specify host' },
    ...
    { name: 'watcher',     type: String,  default: 'events',        aliases: ['w'], description: 'Specify watcher' },
