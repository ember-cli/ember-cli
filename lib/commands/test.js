...
module.exports = Command.extend({
  ...
  availableOptions: [
    ...
    { name: 'reporter',    type: String,  default: 'tap',           aliases: ['r'],  description: 'Test reporter to use [tap|dot|xunit]' },
    ...
    { name: 'path',        type: String,                                             description: 'Reuse an existing build at given path.' },
