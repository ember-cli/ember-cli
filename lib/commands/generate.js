...
module.exports = Command.extend({
  ...
  run: function(commandOptions, rawArgs) {
    ...
    registerAddonBlueprints(this.project);
...
function registerAddonBlueprints(project) {
  project.initializeAddons();
  var addonBlueprintPaths = project.addonBlueprintPaths();

  addonBlueprintPaths.forEach(function(addonBlueprintPath) {
    Blueprint.registerAddonPath(addonBlueprintPath);
  });
};