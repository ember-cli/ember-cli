...
module.exports = Command.extend({
  ...
  availableOptions: [
    { name: 'dry-run',       type: Boolean, default: false, aliases: ['d'], description: 'Dry run, simulate blueprint generation without affecting your project' },
    { name: 'verbose',       type: Boolean, default: false, aliases: ['v'], description: 'Verbose output' },
    { name: 'pod',           type: Boolean, default: false, aliases: ['p'], description: 'Generate blueprint in pod structure' },
    { name: 'classic',       type: Boolean, default: false, aliases: ['c'], description: 'Generate blueprint in classic structure' },
    { name: 'dummy',         type: Boolean, default: false, aliases: ['dum', 'id'], description: 'Generate blueprint in `tests/dummy` when inside an addon project' },
    { name: 'in-repo-addon', type: String,  default: null,  aliases: ['in-repo', 'ir'], description: 'Generate blueprint in specified in-repo-addon when inside a project' }
  ],
