...
module.exports = Command.extend({
  ...
  availableOptions: [
    { name: 'dry-run',    type: Boolean, default: false, aliases: ['d'], description: 'Dry run, simulate project generation' },
    { name: 'verbose',    type: Boolean, default: false, aliases: ['v'], description: 'Verbose output' },
    { name: 'blueprint',  type: String,  default: 'app', aliases: ['b'], description: 'Specify project blueprint' },
    ...
    { name: 'directory',  type: String ,                 aliases: ['dir'], description: 'Specify directory name (if different from project)' }
  ],
