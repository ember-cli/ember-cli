import willInterruptProcess from '../utilities/will-interrupt-process';
import instrumentation from '../utilities/instrumentation';
...
// Main entry point
import requireAsHash from '../utilities/require-as-hash';
import packageConfig from '../../package.json';
import heimdallJsLogger from 'heimdalljs-logger';
import { merge } from 'ember-cli-lodash-subset';
import path from 'path';
import heimdall from 'heimdalljs';

const logger = heimdallJsLogger('ember-cli:cli/index');
