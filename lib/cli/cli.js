...
CLI.prototype.checkNpmVersion = function () {
  return exec('npm --version').then(function (stdout) {
    ...
    if (version.match(/^1\.\d+\.\d+/)) {
      this.ui.writeLine(chalk.red(
        '\n\nYou have NPM ' +
          version +
          ' installed in your system, please upgrade to the latest version for a better experience. See http://git.io/iXnQ_Q\n\n'
      ));
    }
