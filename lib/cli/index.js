...
module.exports = function(options) {
  ...
  console.log('willInterruptProcess.capture()');
  console.trace();
  ...
  return cli.run(environment).finally(() => {
    console.log('willInterruptProcess.release()');
    console.trace();
    return willInterruptProcess.release();
  }).catch(e => {
    console.log('cli.catch');
    console.trace();
