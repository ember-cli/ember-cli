...
module.exports = class Bundler {
  ...
  bundleJs(applicationAndDepsTree, options) {
    ...
    let foobar = new DependencyGraph(applicationAndDepsTree, {
      name: this.name,
      rootedNodeName: this.name,
    });
    const BroccoliDebug = require('broccoli-debug');
    let appJs = concat(new BroccoliDebug(foobar, 'bundler:app-and-deps'), {
    ...
    let vendorFiles = this.getVendorFiles(foobar, scriptOutputFiles);
