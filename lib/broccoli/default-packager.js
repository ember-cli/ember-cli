...
/*
  ...
  @returns {Object} An object with lists of files to be concatenated into `vendor.js` file.
 */
...
module.exports = class DefaultPackager {
   ...
   *
   * @private
   * @function processAppAndDependencies
   * @param {BroccoliTree}
   * @returns {BroccoliTree}
   */
   ...
   *
   * @private
   * @function importAdditionalAssets
   * @param {BroccoliTree}
   * @returns {BroccoliTree}
   */
   ...
   *
   * @private
   * @function packageEmberCliInternalFiles
   * @returns {BroccoliTree}
   */
   ...
   * ```
   * @private
   * @function packageTestApplicationConfig
   */
   ...
   *
   * @private
   * @function packageApplicationTests
   * @param {BroccoliTree}
   * @returns {BroccoliTree}
   */
