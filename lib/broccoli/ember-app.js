...
EmberApp.prototype.appTests = function(coreTestTree) {
    ...
    if (this.hinting) {
      appTestTrees = this.buildTestTrees(appTestTrees);
    }
...
EmberApp.prototype.buildTestTrees = function(testTrees) {
  ...
  testTrees.push(jshintedApp);
  testTrees.push(jshintedTests);
