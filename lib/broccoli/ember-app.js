...
class EmberApp {
  ...
  */
  _initOptions(options) {
    ...
    if (emberCLIBabelInstance) {
      let { version } = this.project.require('ember-cli-babel/package.json');
  ...
  */
  _addonDisabledByBlacklist(addon) {
    let { blacklist } = this.options.addons;
  ...
  */
  _addonDisabledByWhitelist(addon) {
    let { whitelist } = this.options.addons;
