...
const packagerFor = require('./packager-for');

/*
  Default values for Ember Application configuration.
*/
let DEFAULT_CONFIG = {
...
class EmberApp {
  ...
  constructor(defaults, options) {
    ...
    this._debugTree = BroccoliDebug.buildDebugCallback('packager');
    this._packagerFor = packagerFor(this);
  }
  ...
  */
  javascript() {
    ...
    return this._debugTree(this._packagerFor(
      this._debugTree(applicationJs, 'js:input')
    ), 'js:output');
  }
