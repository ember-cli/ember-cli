...
var proxyFixturesTree = require('ember-cli-proxy-fixtures/broccoli');
...
EmberApp.prototype.testFiles = memoize(function() {
  ...
  var proxyFixtures = proxyFixturesTree({
    testFixturesPath: 'tests/fixtures/proxy',
    fixturesVariableName: 'window.proxyFixtures'
  });
