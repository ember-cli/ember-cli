...
class EmberApp {
  ...
  */
  ...
  /**
    ...
    @return
  */
  _processedExternalTree(addonTrees, addonVendorTrees, bowerTree, appVendorTree) {
  ...
  */
  appAndDependencies() {
    ...
    let external = this._processedExternalTree(
      addonTrees, addonVendorTrees, bowerTree, this.trees.vendor
    );
  ...
  */
  styles() {
    if (!this._cachedStylesTree) {
      ...
      let external = this._processedExternalTree(addonTrees, addonVendorTrees, bowerTree, this.trees.vendor);
