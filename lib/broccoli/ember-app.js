...
EmberApp.prototype._initOptions = function(options, isProduction) {
  ...
  this.options = defaultsDeep(options, config, { babel: babelOptions });

  // needs a deeper merge than is provided above
  defaultsDeep(this.options.outputPaths, {
    app: {
      css: {
  ...
  defaultsDeep(this.options.sourcemaps, {
    enabled: !isProduction,
    extensions: ['js']
  });
  ...
  defaultsDeep(this.options.trees, {
  ...
  defaultsDeep(this.options.jshintrc, {
