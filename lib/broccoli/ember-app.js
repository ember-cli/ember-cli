...
class EmberApp {
  ...
  constructor(defaults, options) {
    ...
    console.log(new BroccoliDebug(this.trees.templates, 'assembler:templates-tree'));
  ...
  */
  ...
  _templatesTree() {
    if (!this._cachedTemplateTree) {
      ...
      this._cachedTemplateTree = new BroccoliDebug(this._mergeTrees(trees, {
        annotation: 'TreeMerge (templates)',
      }), 'assembler:app-templates-tree');
    }
