...
EmberApp.prototype._notifyAddonIncluded = function() {
  ...
  var addonNames = this.project.addons.map(addon => addon.name);
...
EmberApp.prototype.addonLintTree = function(type, tree) {
  var output = this.project.addons.map(addon => {
    if (addon.lintTree) {
...
EmberApp.prototype.otherAssets = function() {
  ...
  var otherAssetTrees = funnelReducer(this.otherAssetPaths).map(options => {
