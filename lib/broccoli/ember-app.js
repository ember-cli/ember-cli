...
class EmberApp {
  ...
  */
  ...
  /**
    @private
    @function _addonDisabledByExclude
    @param {Addon} addon
    @returns {Boolean}
  */
  ...
  /**
    @private
    @function _addonDisabledByInclude
    @param {Addon} addon
    @returns {Boolean}
  */
  ...
  */
  ...
  /**
    ...
    @returns {Object} Alias to the project's dependencies function
  */
  dependencies(pkg) {
  ...
  /**
    ...
    @returns {(String|undefined)} assetPath
   */
  _getAssetPath(asset) {
    /* @type {String} */
    let assetPath;
  ...
  /**
    ...
    @private
    @function toArray
    @returns {Array} An array of trees
   */
  toArray() {
    return [
  ...
  /**
    ...
    @returns {Tree}                  Merged tree for this application
   */
