...
class EmberApp {
  ...
  */
  ...
  lintTestTrees() {
    ...
    let lintedTestSupport = this.addonLintTree('test-support', testSupportTree);
    ...
    lintedTestSupport = processModulesOnly(new Funnel(lintedTestSupport, {
      srcDir: '/',
      destDir: `${this.name}/tests/`,
      annotation: 'Funnel (lint test-support)',
    }), 'Babel: lintTree(test-support)');

    return [lintedApp, lintedTests, lintedTemplates, lintedTestSupport];
  }
