...
let p = require('ember-cli-preprocess-registry/preprocessors');
...
let ConfigReplace = require('broccoli-config-replace');
let ConfigLoader = require('broccoli-config-loader');
let mergeTrees = require('./merge-trees');
let shimAmd = require('./amd-shim');
...
let defaultsDeep = require('ember-cli-lodash-subset').defaultsDeep;
let omitBy = require('ember-cli-lodash-subset').omitBy;
let isNull = require('ember-cli-lodash-subset').isNull;
let Funnel = require('broccoli-funnel');
let funnelReducer = require('broccoli-funnel-reducer');
