...
function EmberApp(options) {
  ...
  this.vendorFiles = merge(options.vendorFiles, {
    ...
    'qunit.js' : [
      this.bowerDirectory + '/qunit/qunit/qunit.js', {
        type: 'test '
      }
    ],
    'qunit.css': [
      this.bowerDirectory + '/qunit/qunit/qunit.css', {
        type: 'test'
      }
    ],
    'qunit-notifications.js': [
      this.bowerDirectory + '/qunit-notifications/index.js', {
        type: 'test'
      }
    ]
  }, defaults);
...
EmberApp.prototype.javascript = function() {
  ...
  if (this.tests) {
    this.import(this.bowerDirectory + '/ember-qunit/dist/named-amd/main.js', {
      exports: {
        'ember-qunit': [
          'globalize',
          'moduleFor',
    ...
    this.import(this.bowerDirectory + '/ember-cli-shims/test-shims.js', {
      exports: {
        'qunit': ['default']
      }
    });
