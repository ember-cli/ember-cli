...
Blueprint.prototype.install = function(intoDir, templateVariables, dryRun) {
  ...
  return this.processFiles(intoDir, templateVariables, ui).map(commit).then(function() {
    ui.write('pls work');
  }).catch(function(error) {
    ui.write('dunno' + error.message);
  });
};
...
Blueprint.prototype.processFiles = function(intoDir, templateVariables, ui) {
