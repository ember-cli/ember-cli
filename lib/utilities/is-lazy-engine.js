 ...
 *
 * @private
 * @function * @param {Object} addonCtorOrInstance the constructor function/class or an instance of an Addon.
 * @returns {Boolean} True if the addonCtorOrInstance is a lazy engine, False otherwise.
 */
