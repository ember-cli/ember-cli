...
class WindowsSymlinkChecker {
   ...
   *
   * @public
   * @function checkIfSymlinksNeedToBeEnabled
   * @returns {Promise<Object>} Object describing whether we're on windows and if admin rights exist
   */
   ...
   *
   * @private
   * @function _checkForElevatedRights
   * @param  {Object} ui - ui object used to call writeLine();
   * @returns {Object} Object describing whether we're on windows and if admin rights exist
   */
