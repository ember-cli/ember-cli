...
class WindowsSymlinkChecker {
   ...
   * and usable. This object, when queried, informs Windows users regarding
   ...
   *    * if the user is an admin, the process needs to have been started with elevated priveleges
