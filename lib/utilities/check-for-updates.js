...
function checkForUpdates(ui, environment) {
  var lastVersionCheck = (environment && environment.settings)? environment.settings.lastVersionCheck : null;
  var now = new Date().getTime();
  var version = null;

  return new Promise(function(resolve, reject) {
    // if the last check was less than a day ago, do not do an npm call to check version
...
/**
* Compares new & local version numbers to determine if an update is needed. If so, displays a message to the user.
* @param {UI} ui
