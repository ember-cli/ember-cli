...
describe('Acceptance: smoke-test', function() {
  ...
  (experiments.MODULE_UNIFICATION ? it.skip : it)('ember new foo, make sure addon template overwrites', co.wrap(function *() {
  ...
  (experiments.MODULE_UNIFICATION ? it.skip : it)('ember build exits with non-zero code when build fails', co.wrap(function *() {
  ...
  (experiments.MODULE_UNIFICATION ? it.skip : it)('ember can override and reuse the built-in blueprints', co.wrap(function *() {
