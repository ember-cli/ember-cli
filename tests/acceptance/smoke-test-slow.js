...
describe('Acceptance: smoke-test', function() {
  ...
  it(
    'ember new foo, make sure addon template overwrites',
    co.wrap(function*() {
  ...
  it(
    'ember test still runs when a JavaScript testem config exists',
    co.wrap(function*() {
  ...
  it(
    'eslint passes after running ember new',
    co.wrap(function*() {
      let result = yield runCommand(path.join('.', 'node_modules', 'eslint', 'bin', 'eslint.js'), appRoot);
  ...
  it.skip(
    'ember new foo, build production and verify fingerprint',
    co.wrap(function*() {
      yield runCommand(
  ...
  it(
    'ember new foo, build development, and verify generated files',
    co.wrap(function*() {
      yield runCommand(path.join('.', 'node_modules', 'ember-cli', 'bin', 'ember'), 'build');
  ...
  it(
    'ember build exits with non-zero code when build fails',
    co.wrap(function*() {
      ...
      result = yield expect(runCommand(path.join('.', 'node_modules', 'ember-cli', 'bin', 'ember'), 'build')).to.be
        .rejected;
  ...
  it(
    'ember build generates instrumentation files when viz is enabled',
    co.wrap(function*() {
  ...
  it.skip(
    'ember new foo, server, SIGINT clears tmp/',
    co.wrap(function*() {
      let result = yield runCommand(
        path.join('.', 'node_modules', 'ember-cli', 'bin', 'ember'),
        'server',
  ...
  it(
    'ember new foo, build production and verify css files are concatenated',
    co.wrap(function*() {
  ...
  it(
    'ember new foo, build production and verify css files are minified',
    co.wrap(function*() {
      yield copyFixtureFiles(
        isExperimentEnabled('MODULE_UNIFICATION') ? 'with-unminified-styles-mu' : 'with-unminified-styles'
      );
  ...
  it(
    'ember new foo, build production and verify single "use strict";',
    co.wrap(function*() {
      yield runCommand(
        path.join('.', 'node_modules', 'ember-cli', 'bin', 'ember'),
        'build',
  ...
  it(
    'ember can override and reuse the built-in blueprints',
    co.wrap(function*() {
  ...
  it(
    ...
    co.wrap(function*() {
      ...
      let result = yield expect(runCommand(path.join('.', 'node_modules', 'ember-cli', 'bin', 'ember'), 'test')).to.be
        .rejected;
