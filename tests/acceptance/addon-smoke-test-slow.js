...
describe('Acceptance: addon-smoke-test', function () {
  ...
  it('works with ember-cli-build.js at addon root', async function () {
    await copyFixtureFiles('addon/ember-cli-build-at-root');

    // remove the file generated by the blueprint
    fs.unlinkSync(path.join(addonRoot, 'tests/dummy/ember-cli-build.js'));
  ...
  it('works with passed --build-file-path', async function () {
    await copyFixtureFiles('addon/ember-cli-build-named-differently');

    // remove the file generated by the blueprint
    fs.unlinkSync(path.join(addonRoot, 'tests/dummy/ember-cli-build.js'));
    let result = await runCommand('node_modules/ember-cli/bin/ember', 'build', '--build-file-path=ember.js');
