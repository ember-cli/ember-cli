...
function install (args, cb_) {
  console.log('OMG INSTALL', args, cb_);

  var hasArguments = !!args.length
  console.log('OMG INSTALL2');

  function cb (er, installed) {
    console.log('such callback', er, installed);
    if (er) return cb_(er)
  ...
  console.log('OMG INSTALL3');
  console.log('OMG2')
  // the /path/to/node_modules/..
  var where = path.resolve(npm.dir, "..")
  console.log('OMG INSTALL4');
  console.log(where)
