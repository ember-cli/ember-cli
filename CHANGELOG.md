...
- [#3880](https://github.com/ember-cli/ember-cli/pull/3880) Revert "Export return value from Router.map (closes #3676)." [@ember-cli](https://github.com/ember-cli)
...
- [#3983](https://github.com/ember-cli/ember-cli/pull/3983) Revert "Changed markdown-color blue to bright-blue to be the same on all... [@ember-cli](https://github.com/ember-cli)
