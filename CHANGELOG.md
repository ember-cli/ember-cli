...
* [ENHANCEMENT] Adds ember-cli-proxy-fixtures for capturing and replaying proxy requests in test runs [#882](https://github.com/stefanpenner/ember-cli/pull/882)
